...
const Toggle = styled.button`
    ${tw`border-2 border-white rounded-full flex cursor-pointer w-20 justify-between items-center text-white overflow-hidden absolute right-0 top-0 mr-2 mt-2`}
    background: ${({ theme }) =>
        theme.darkMode
